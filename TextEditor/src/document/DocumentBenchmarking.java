	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int i = 0; i < trials ; i++) {
				BasicDocument basicDocumentObject  = new BasicDocument(text);
				basicDocumentObject.getFleschScore();
			}
			...
			for (int i = 0; i < trials ; i++) {
				EfficientDocument efficientDocumentObject  = new EfficientDocument(text);
				efficientDocumentObject.getFleschScore();
			}
